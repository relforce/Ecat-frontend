...
import { BACKEND_URL, X_CHANNEL_LINK } from "../../constants";
import axios from "axios";
import { PointContext } from "../../state/PointContext";
import { Link } from "react-router-dom";
import toast from "react-hot-toast";
const XChannelDialog = ({ setDialogOpen, animateLeaves }) => {
  ...
  const handleClick = async () => {
    if (!followed) {
      toast.error("You haven't followed yet. Please follow first!");
      return false;
    }
      ...
      <div className="bs-content">
        <div className="bs-content-image">
          <div className="earn-image is-coin-star">
            <picture>
              <source
                srcSet="/images/earn/x.png"
                type="image/png"
                alt="subscribe_telegram_channel"
              />
              <img
                className="img-responsive"
                src="/images/earn/x.png"
                alt="subscribe_telegram_channel"
              />
            </picture>
          </div>
        </div>
        <div className="bs-content-title">Follow our X account</div>
