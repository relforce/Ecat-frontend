...
import { BACKEND_URL, BLUM_CHANNEL } from "../../constants";
import axios from "axios";
import { PointContext } from "../../state/PointContext";
import { Link } from "react-router-dom";
import toast from "react-hot-toast";
const BlumChannelDialog = ({ setDialogOpen, animateLeaves }) => {
  ...
  return (
    <div className="bottom-sheet-scroll">
      <div className="bs-content">
        ...
        <div className="bs-content-title">Play Blum and Earn +10,000</div>
...
export default BlumChannelDialog;
