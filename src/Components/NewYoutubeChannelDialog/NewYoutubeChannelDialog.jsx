...
import { BACKEND_URL, NEW_YOUTUBE_CHANNEL } from "../../constants";
import axios from "axios";
import { PointContext } from "../../state/PointContext";
import { Link, useNavigate } from "react-router-dom";
import toast from "react-hot-toast";

const NewYoutubeChannelDialog = ({ setDialogOpen, animateLeaves }) => {
  ...
  return (
    <div className="bottom-sheet-scroll">
      <div className="bs-content">
        ...
        <div className="bs-content-title">View our breaking News</div>
        <div className="bs-content-description">
          <Link
            to={NEW_YOUTUBE_CHANNEL}
            target="_blank"
...
export default NewYoutubeChannelDialog;
